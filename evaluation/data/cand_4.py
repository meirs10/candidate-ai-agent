...
GOLDEN=[
  ...
  {"id":"q062","question":"How proficient is the candidate in PyTorch?","ground_truth":"PyTorch is one of the candidate's core, well-evidenced skills. He uses it in the recommendation engine, the fraud-detection pipeline, and his capstone drone-navigation project.","expected_source":"skill","category":"proficiency","difficulty":"easy","expected_route":None},
  {"id":"q063","question":"Rate the candidate's Python skills.","ground_truth":"Python is well-evidenced as the candidate's primary language, used across all his roles and projects.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
  {"id":"q064","question":"What are the candidate's strongest skills?","ground_truth":"The candidate's strongest, best-evidenced skills are Python, PyTorch, AWS, Kubernetes, and TensorFlow — demonstrated across his machine-learning and infrastructure work.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
