...
GOLDEN=[
    ...
    {"id":"q062","question":"How proficient is the candidate in React?","ground_truth":"React is one of the candidate's core, strongly-evidenced skills. She leads a React design system of 60+ components and built the ReactA11y Hooks library.","expected_source":"skill","category":"proficiency","difficulty":"easy","expected_route":None},
    {"id":"q063","question":"Rate the candidate's TypeScript skills.","ground_truth":"TypeScript is well-evidenced in the candidate's work. She uses it across her React applications and the Fiverr design system.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
    {"id":"q064","question":"What are the candidate's strongest skills?","ground_truth":"The candidate's strongest, best-evidenced skills are React, TypeScript, CSS3, Python, and Docker — shown across her frontend and design-system work.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
