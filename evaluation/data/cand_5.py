...
GOLDEN=[
    ...
    {"id":"q062","question":"How proficient is the candidate in SQL?","ground_truth":"SQL is a well-evidenced data skill for the candidate, used for analytics, reporting, and predictive modelling.","expected_source":"skill","category":"proficiency","difficulty":"easy","expected_route":None},
    {"id":"q063","question":"Rate the candidate's Tableau skills.","ground_truth":"Tableau is evidenced in the candidate's background, listed among her data and analytics visualization tools.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
    {"id":"q064","question":"What are the candidate's strongest skills?","ground_truth":"The candidate's strongest, best-evidenced skills are SQL, Python, Tableau, Amplitude, and Mixpanel — shown across her analytics and product-data work.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
