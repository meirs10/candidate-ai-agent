...
GOLDEN=[
    ...
    {"id":"q062","question":"How proficient is the candidate in Python?","ground_truth":"Python is one of the candidate's core, well-evidenced skills. She uses it extensively across her security tooling, automation, and malware analysis work.","expected_source":"skill","category":"proficiency","difficulty":"easy","expected_route":None},
    {"id":"q063","question":"Rate the candidate's Splunk skills.","ground_truth":"Splunk is well-evidenced in the candidate's background. She built SIEM correlation rules in Splunk and uses it for threat-intelligence correlation.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
    {"id":"q064","question":"What are the candidate's strongest skills?","ground_truth":"The candidate's strongest, best-evidenced skills are Python, Burp Suite, AWS, Kubernetes, and Splunk — shown across her security tooling, cloud, and container work.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
