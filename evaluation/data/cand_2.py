...
GOLDEN=[
    ...
    {"id":"q033","question":"Does the candidate have experience with Kubernetes?","ground_truth":"Yes, Kubernetes is a core skill. Yoni manages 15 clusters (EKS and GKE) with 2,000+ pods, built a custom autoscaler, and holds the CKA certification.","expected_source":"docs","accept_sources":["skill"],"category":"skills","difficulty":"easy","expected_route":"specific"},
    ...
    {"id":"q062","question":"How proficient is the candidate in Kubernetes?","ground_truth":"The candidate has a verified, model-estimated proficiency level (1-5) in Kubernetes, inferred from his documents with supporting evidence. Kubernetes is a core, strongly-evidenced skill — he manages 15 clusters with 2,000+ pods and holds the CKA certification.","expected_source":"skill","category":"proficiency","difficulty":"easy","expected_route":None},
    {"id":"q063","question":"Rate the candidate's Terraform skills.","ground_truth":"Provides a model-estimated 1-5 proficiency level for Terraform, inferred from the documents with evidence. Terraform is well-evidenced — used for IaC across 100+ microservices and in the TerraLint open-source tool.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
    {"id":"q064","question":"What are the candidate's strongest skills?","ground_truth":"Provides a ranked list of the candidate's assessed skills (Kubernetes, Terraform, AWS, Go, Prometheus) with their estimated 1-5 proficiency levels, inferred from the documents.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
    {"id":"q065","question":"How strong is the candidate at Istio?","ground_truth":"Istio is not among the explicitly assessed skills, so this is answered from the documents: Yoni uses the Istio service mesh for traffic management in the multi-cloud migration framework.","expected_source":"docs","category":"proficiency","difficulty":"medium","expected_route":None},
