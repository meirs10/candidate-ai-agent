...
GOLDEN=[
    ...
    {"id":"q062","question":"How proficient is the candidate in Kubernetes?","ground_truth":"Kubernetes is one of the candidate's core, strongly-evidenced skills. He manages 15 clusters with 2,000+ pods and holds the CKA certification.","expected_source":"skill","category":"proficiency","difficulty":"easy","expected_route":None},
    {"id":"q063","question":"Rate the candidate's Terraform skills.","ground_truth":"Terraform is well-evidenced in the candidate's work. He uses it for infrastructure-as-code across 100+ microservices and built the TerraLint open-source tool.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
    {"id":"q064","question":"What are the candidate's strongest skills?","ground_truth":"The candidate's strongest, best-evidenced skills are Kubernetes, Terraform, AWS, Go, and Prometheus — demonstrated across his platform and infrastructure work.","expected_source":"skill","category":"proficiency","difficulty":"medium","expected_route":None},
