...
res = run_evaluation(
    ...
    # Keep the ChromaDB collections a previous run built. They are deterministic
    # for unchanged documents, and re-ingesting would re-pay every per-document
    # summary call. Flip to False if the documents, chunker, or EMBED_PROVIDER
